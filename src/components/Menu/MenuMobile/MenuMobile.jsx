  ...
  return (
    <div className='menu-mobile'>
      ...
      <div className='menu-mobile-section-2'>
        <button className='menu-mobile-section-2-button' onClick={openPdfMenu}>Download menu</button>
        <button className='menu-mobile-section-2-button' onClick={openPdfDrinks}>Drinks</button>
        <button className='menu-mobile-section-2-button' onClick={openPdfBar}>Bar</button>
        <button className='menu-mobile-section-2-button' onClick={openPdfWine}>Wine</button>
      </div>
    </div>
  )
}
